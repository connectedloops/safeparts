...
- Local dependency reports: `mise run security:scan`; scope, freshness, fail-closed exits and the separately invoked retired-source inventory are owned by `docs/dev/dependency-scans.md` and `scripts/dev/dependency_scan.py`. Preserve the independent RustSec audit.
